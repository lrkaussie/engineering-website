            ...
            <ul className="space-y-1 md:space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-slate-400 hover:text-orange-400 transition-colors text-sm md:text-base"
                  >
                    {link.title}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 md:space-y-4">
              ...
              <li className="flex items-center">
                <Phone className="h-4 w-4 md:h-5 md:w-5 text-orange-500 mr-2 md:mr-3" />
                <span className="text-slate-400 text-sm md:text-base">{siteConfig.contact.phone}</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-4 w-4 md:h-5 md:w-5 text-orange-500 mr-2 md:mr-3" />
                <a
